    ...
    <center>
        ...
        while ($fila = mysqli_fetch_assoc($resultado)): ?>
            <div class="contenido_item">
                ...
                <form action="../../verificar/verificar_quiz_completar_frases.php" method="POST">
                    <input type="hidden" name="frase" value="<?php echo $fila['frase']; ?>">
                    <input type="text" name="respuesta_usuario" class="respuesta" placeholder="Escribe la palabra faltante" autocomplete="off" required>
                    <br><br>
