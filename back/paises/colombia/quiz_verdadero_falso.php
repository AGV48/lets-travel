    ...
    <center>
        ...
        <?php if ($nombre === 'admin'): ?>
            <div class="subir_contenido">
                ...
                <form action="../../subir/subir_quiz_verdadero_falso.php" method="POST">
        ...
        <?php while ($fila = mysqli_fetch_assoc($resultado)): ?>
            <div class="contenido_item">
                <div class="div_eliminar">
                    <form action="../../eliminar_y_cambiar/eliminar_quiz_verdadero_falso.php" method="POST">
                ...
                <form action="../../verificar/verificar_quiz_verdadero_falso.php" method="POST">
                    <input type="hidden" name="pregunta_id" value="<?php echo $fila['pregunta']; ?>">
